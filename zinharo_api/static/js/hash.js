function get_cap() {
    ...
    xhr.onloadend = function () {
        ...
        if (xhr.status == 404) {
            ...
            var content_cap_body = "<h3>Base64-formatted body</h3><p>Below is the body of this .cap in base64 form. This can be up to 2.5mb so it may be long!</p><p class=\"cap-body\">" + hash.cap + "</p>"
